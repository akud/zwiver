  ...
  test('Switch Buttons', function() {
    ...
    QUnit.delay(function() {
      ...
      QUnit.delay(function() {
        ...
        equal(ZWVR.switchButtons.get('mapImg'), '/images/map-unselected.png', 
          'clicking already selected button does not change state');
        equal($('#map-container').css('display'), 'none', 
          'clicking already selected button does not show map');
        equal($('#list-container').css('display'), 'block', 
          'clicking already selected button does not hide list');
        ...
        QUnit.delay(function() {
          ...
          equal($('#map-container').css('display'), 'block', 
            'clicking map button shows map');
          equal($('#list-container').css('display'), 'none', 
            'clicking map button hides list');
        });
      });
    });
  });
